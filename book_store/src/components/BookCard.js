...
import { deleteBook } from "../redux/books/actionType";
      ...
      <div className="flex-1 h-full pr-2 pt-2 flex flex-col">
        <div
          className={`flex items-center ${
            book.featured ? "justify-between" : "justify-end"
          }`}
        >
          {book.featured && (
          ...
          <div className="text-gray-500 space-x-2">
            ...
            <button onClick={handleBookDelete} className="lws-delete">
              <svg
                fill="none"
                viewBox="0 0 24 24"
                strokeWidth="1.5"
        ...
        <div className="space-y-2 mt-4 h-full">
          ...
          <div className="lws-stars">
            {[...Array(Number(book.rating))].map((_, index) => (
              <svg
                key={index}
                viewBox="0 0 20 20"
                fill="currentColor"
